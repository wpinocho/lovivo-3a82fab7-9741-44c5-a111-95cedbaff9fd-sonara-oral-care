...
export const useCheckoutLogic = () => {
  ...
  useEffect(() => {
    saveClientData();
    // Enrich Meta CAPI / Pixel matching with whatever the user has typed so far.
    // tracking.setUserData merges incrementally — undefined fields don't clear.
  ...
  }, [email, firstName, lastName, phone, orderId, address.city, address.state, address.postal_code, address.country, address.countryCode]);
